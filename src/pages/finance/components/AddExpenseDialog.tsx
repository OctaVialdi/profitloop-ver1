...
import { Calendar as CalendarIcon, Users, SlidersHorizontal, Check, UploadCloud, Plus, Trash } from "lucide-react";
...
const AddExpenseDialog: React.FC = () => {
  ...
  const { categories, fetchCategories, addCategory, deleteCategory, addExpense } = useExpenses();
  ...
  const confirmDeleteCategory = async () => {
    ...
    if (success && category === categoryToDelete.name) {
      setCategory(""); // Reset selected category if it was deleted
    }
