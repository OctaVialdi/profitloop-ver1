...
import { BarChart, Users, Plus, ChevronDown, Search, SlidersHorizontal, LineChart, Wallet, BarChart3, ArrowLeft, Upload, ArrowLeftCircle } from "lucide-react";
...
const KolManagement = () => {
  ...
  // Render KOL Detail View
  const renderKolDetailView = () => {
      ...
      <div className="flex flex-col space-y-6 p-6">
        ...
        <Tabs defaultValue="general" className="w-full">
          ...
          <TabsContent value="social" className="mt-6">
            {/* Social media content - similar to add KOL form */}
          ...
          <TabsContent value="rates" className="mt-6">
            {/* Rates content - similar to add KOL form */}
            <div className="space-y-6">
              <div>
          ...
          <TabsContent value="metrics" className="mt-6">
            {/* Metrics content - similar to add KOL form */}
            <div>
