  ...
  public: {
    Tables: {
      ...
      content_plans: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["pic_id"]
            isOneToOne: false
            referencedRelation: "team_members_digital_marketing"
            referencedColumns: ["id"]
          },
          {
      ...
      expense_category_types: {
        ...
        Relationships: [
          {
            foreignKeyName: "expense_category_types_category_id_fkey"
            columns: ["category_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "expense_category_types_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      kols: {
        ...
        Relationships: [
          {
            foreignKeyName: "kols_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
