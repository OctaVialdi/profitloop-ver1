...
export const EditWorkExperienceDialog: React.FC<EditWorkExperienceDialogProps> = ({
  open,
  experience,
  onOpenChange,
  onSuccess,
  ...
  const handleSubmit = async (data: WorkExperience) => {
    if (!experience.id) return;

    setIsSubmitting(true);
    try {
      await educationService.updateWorkExperience(experience.id, data);
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Update details about job experience.
          </DialogDescription>
        </DialogHeader>
