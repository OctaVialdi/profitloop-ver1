...
interface AddInformalEducationDialogProps {
  open: boolean;
  employeeId: string;
...
export const AddInformalEducationDialog: React.FC<AddInformalEducationDialogProps> = ({
  open,
  employeeId,
  onOpenChange,
  onSuccess,
  ...
  const handleSubmit = async (data: InformalEducation) => {
    ...
    try {
      await educationService.addInformalEducation(data);
      toast.success("Informal education added successfully");
      form.reset();
      onOpenChange(false);
      if (onSuccess) onSuccess();
    } catch (error: any) {
      toast.error("Failed to add informal education", {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          <DialogTitle>Add Informal Education</DialogTitle>
          <DialogDescription>
            Add details about courses, certifications, or trainings.
          </DialogDescription>
        </DialogHeader>
