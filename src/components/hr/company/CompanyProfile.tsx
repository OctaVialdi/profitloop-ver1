...
const CompanyProfile: React.FC = () => {
  ...
  // Removed: handleAddDepartment and handleRemoveDepartment functions
  ...
  // Modified: departments is now an array of OrganizationName objects
      ...
      {!isEditing ? (
        <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-6">
              {/* Departments Card - Modified to show read-only departments from employee_employment */}
              <Card>
                <CardHeader>
                ...
                <CardContent>
                  {departments.length > 0 ? (
                    ...
                    <div className="text-center p-6 border rounded-md">
                      <p className="text-muted-foreground">No departments found in employee assignments</p>
                      <p className="text-xs text-muted-foreground mt-2">
                        Departments are derived from employee organization assignments
                      </p>
                    </div>
                  )}
                </CardContent>
