      ...
      <Table className="w-full">
        <TableHeader className="sticky top-0 bg-white z-20">
          <TableRow>
            ...
            <TableHead className="w-[100px] text-center">PIC</TableHead>
            ...
            <TableHead className="w-[140px] text-center">Brief</TableHead>
              ...
              <TableRow key={item.id}>
                  ...
                  {item.brief ? (
                    <div className="flex items-center space-x-1">
                      <Button 
                        variant="outline"
                        size="sm"
                        className="text-left truncate w-full text-xs px-2 h-7"
                ...
                <TableCell className="p-1">
                  <div className="flex items-center justify-between">
                    <div className="font-medium text-center w-full text-sm">
