              ...
              <TableHeader className="sticky top-0 bg-white z-20">
                <TableRow className="bg-slate-50">
                  {isColumnVisible("selectColumn") && (
                    <TableHead className="w-[70px] text-center sticky left-0 bg-slate-50 z-30 border-r">
                      <Checkbox 
                        checked={selectAll} 
                  ...
                  {isColumnVisible("postDate") && (
                    <TableHead className="w-[180px] text-center font-medium whitespace-nowrap">Tanggal Posting</TableHead>
                  )}
                  {isColumnVisible("contentType") && (
                    <TableHead className="w-[180px] text-center font-medium whitespace-nowrap">Tipe Content</TableHead>
                  )}
                  {isColumnVisible("pic") && (
                    <TableHead className="w-[160px] text-center font-medium whitespace-nowrap">PIC</TableHead>
                  )}
                  {isColumnVisible("service") && (
                    <TableHead className="w-[180px] text-center font-medium whitespace-nowrap">Layanan</TableHead>
                  )}
                  {isColumnVisible("subService") && (
                    <TableHead className="w-[180px] text-center font-medium whitespace-nowrap">Sub Layanan</TableHead>
                  )}
                  {isColumnVisible("title") && (
                    <TableHead className="w-[240px] text-center font-medium whitespace-nowrap">Judul Content</TableHead>
                  )}
                  {isColumnVisible("contentPillar") && (
                    <TableHead className="w-[180px] text-center font-medium whitespace-nowrap">Content Pillar</TableHead>
                  )}
                  {isColumnVisible("brief") && (
                    <TableHead className="w-[240px] text-center font-medium whitespace-nowrap">Brief</TableHead>
                  )}
                  {isColumnVisible("status") && (
                    <TableHead className="w-[180px] text-center font-medium whitespace-nowrap">Status</TableHead>
                  )}
                  {isColumnVisible("revision") && (
                    <TableHead className="w-[140px] text-center font-medium whitespace-nowrap">Revision</TableHead>
                  )}
                  {isColumnVisible("approved") && (
                    <TableHead className="w-[140px] text-center font-medium whitespace-nowrap">Approved</TableHead>
                  )}
                  {isColumnVisible("completionDate") && (
                    <TableHead className="w-[200px] text-center font-medium whitespace-nowrap">Tanggal Selesai</TableHead>
                  )}
                  {isColumnVisible("mirrorPostDate") && (
                    <TableHead className="w-[180px] text-center font-medium whitespace-nowrap">Tanggal Upload</TableHead>
                  )}
