...
/**
 * Track feature discovery and recommendations
 */
export function trackFeatureDiscovery(
  ...
  try {
    ...
    console.error("Error in trackFeatureDiscovery:", error);
  }
}
 ...
 */
export function trackMilestoneInteraction(
  milestoneId: string,
  ...
  try {
    ...
    supabase.functions.invoke('track-event', {
      body: {
        event_type: 'milestone_interaction',
        organization_id: organizationId,
        additional_data: {
          milestone_id: milestoneId,
          action: action,
      ...
      console.error("Failed to track milestone interaction:", error);
    });
  } catch (error) {
    console.error("Error in trackMilestoneInteraction:", error);
  }
}
